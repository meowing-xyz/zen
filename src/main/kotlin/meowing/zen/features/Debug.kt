...
object Debug : Feature() {
    ...
    init {
        EventBus.register<meowing.zen.events.ItemTooltipEvent> { event ->
            ...
            pricingData.takeIf { it.has("activeBin") || it.has("activeAuc") }?.let {
                ...
                event.lines.add("§3Active: §a$activeBin BIN §7| §b$activeAuc AUC")
            }
            ...
            pricingData.takeIf { it.has("binSold") || it.has("aucSold") }?.let {
                ...
                event.lines.add("§3Sales/day: §a$soldBin BIN §7| §b$soldAuc AUC")
            }
            ...
            pricingData.takeIf { it.has("avgLowestBin") && it.has("lowestBin") }?.let {
                ...
                event.lines.add("§3BIN: §7AVG §e$avgLowestBin §8| §7LOW §e$lowestBin")
            }
            ...
            pricingData.takeIf { it.has("avgAucPrice") && it.has("aucPrice") }?.let {
                ...
                event.lines.add("§3AUC: §7AVG §e$avgAucPrice §8| §7SOON §e$aucPrice")
            }
            ...
            pricingData.takeIf { it.has("bazaarBuy") || it.has("bazaarSell") }?.let {
                ...
                event.lines.add("§3Bazaar: §a$bazaarBuy Buy §7| §b$bazaarSell Sell")
            }
        }
    }
